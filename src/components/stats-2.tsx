      ...
      <div className="mx-auto max-w-2xl px-6">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-balance">
            We deliver measurable results that help ambitious brands grow
            sustainably — across every channel and every stage.
          </p>
        </div>
        <div className="@xl:grid-cols-3 mt-12 grid grid-cols-2 gap-6 text-sm">
          <div className="border-y py-6">
            <p className="text-muted-foreground text-xl">
              <span className="text-foreground font-medium">50+</span> brands
              served across SEA.
            </p>
          </div>
          ...
          <div className="border-y py-6">
            <p className="text-muted-foreground text-xl">
              <span className="text-foreground font-medium">RM60M+</span> in ad
              budget managed.
            </p>
          </div>
          ...
          <div className="border-y py-6">
            <p className="text-muted-foreground text-xl">
              <span className="text-foreground font-medium">4.9/5</span> average
              client rating.
            </p>
          </div>
        </div>

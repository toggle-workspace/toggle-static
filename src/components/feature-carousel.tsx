...
const mockPosts = [
  {
    ...
    excerpt: "UNITAR needed to scale student acquisition without inflating costs. We ran a full-funnel campaign across TikTok, Meta, and Google — and captured 77% of total impressions in the Education category in Malaysia.",
    author: "Toggle Team",
  ...
  },
  {
    ...
    excerpt: "CIMB's product pages lacked keyword depth and their blog had content that diluted quality signals. We rebuilt their content strategy from the ground up — and organic clicks grew 34.5% within a year.",
    author: "Toggle Team",
  ...
  },
  {
    ...
    excerpt: "Kith & Kin had never run paid advertising before — they relied entirely on organic and cold-calling. Three months of targeted Meta campaigns later: 392% more leads, RM35 CPL, and a 10% conversion rate from lead to closed deal.",
    author: "Toggle Team",
  ...
  },
  {
    ...
    excerpt: "Singlife's core insurance keywords sat at position three — close, but far enough to feel the traffic gap every month. We rebuilt their on-page content around intent alignment and E-E-A-T signals. Organic clicks grew 23%.",
    author: "Toggle Team",

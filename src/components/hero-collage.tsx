export default function HeroCollage() {
  return (
    <section className="bg-background py-12 md:py-20 w-full">
      <div className="container max-w-[98.125rem]">
        <div className="grid grid-cols-1 items-center justify-between gap-14 lg:grid-cols-2">
          ...
          <div className="flex w-full max-w-[31.25rem] flex-col gap-14 lg:max-w-full">
            <h1 className="text-6xl text-foreground lg:text-7xl xl:text-[5rem]">
              Revolutionize your business operations
            </h1>
            <p className="text-2xl leading-snug text-foreground lg:text-3xl xl:text-4xl">
